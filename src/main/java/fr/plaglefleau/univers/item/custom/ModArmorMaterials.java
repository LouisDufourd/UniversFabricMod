package fr.plaglefleau.univers.item.custom;
...
public enum ModArmorMaterials implements ArmorMaterial {
    PLATINUM("platinum", 24, new int[] {3,7,6,3}, 10, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 1f, 0f,
    ...
    public String getName() {
        return "%1s:%2s".formatted(Univers.MOD_ID, name);
    }
